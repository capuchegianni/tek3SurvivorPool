...
@customers_blueprint.route('/api/customers/<customer_id>/image', methods=['POST'])
...
@customers_blueprint.route('/api/customers/<customer_id>/image', methods=['PUT'])
@jwt_required(locations='cookies')
@role_required('Admin')
...
@customers_blueprint.route('/api/customers/<customer_id>/image', methods=['DELETE'])
@jwt_required(locations='cookies')
@role_required('Admin')
