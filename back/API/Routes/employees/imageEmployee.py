...
@employees_blueprint.route('/api/employees/<employee_id>/image', methods=['POST'])
...
@employees_blueprint.route('/api/employees/<employee_id>/image', methods=['PUT'])
@jwt_required(locations='cookies')
@role_required('Admin')
...
@employees_blueprint.route('/api/employees/<employee_id>/image', methods=['DELETE'])
@jwt_required(locations='cookies')
@role_required('Admin')
